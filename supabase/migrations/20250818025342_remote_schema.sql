...
ALTER TABLE ONLY "public"."note_images"
    ADD CONSTRAINT "note_images_file_url_key" UNIQUE ("file_url");



ALTER TABLE ONLY "public"."note_images"
    ADD CONSTRAINT "note_images_note_id_key" UNIQUE ("note_id");
...
GRANT ALL ON TABLE "public"."note_images" TO "anon";
GRANT ALL ON TABLE "public"."note_images" TO "authenticated";
